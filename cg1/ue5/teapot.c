...
char* readOBJ(char* obj){
    ...
    GLfloat* v_arr = malloc(sizeof(GLfloat) * v_count); 
    GLfloat* vn_arr = malloc(sizeof(GLfloat) * vn_count); 
    GLfloat* vt_arr = malloc(sizeof(GLfloat) * vt_count); 
    GLfloat* f_arr = malloc(sizeof(GLfloat) * f_count);
